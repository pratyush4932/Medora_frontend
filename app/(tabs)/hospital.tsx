    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.hospitalIcon}>
              <MaterialIcons name="local-hospital" size={moderateScale(24)} color={Colors.primary} />
            </View>
            <View>
              ...
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.metaRow}>
                    <MaterialIcons name="calendar-today" size={moderateScale(16)} color={Colors.onSurfaceVariant} />
                    <Text style={styles.metaText}>Oct 24, 2023</Text>
                  </View>
                  <View style={styles.metaRow}>
                    <MaterialIcons name="person" size={moderateScale(16)} color={Colors.onSurfaceVariant} />
                    <Text style={styles.metaText}>Dr. Sarah Jenkins</Text>
                  </View>
                  <View style={styles.metaRow}>
                    <MaterialIcons name="category" size={moderateScale(16)} color={Colors.onSurfaceVariant} />
                    <Text style={styles.metaText}>Lab Result</Text>
                  </View>
                </View>
                <MaterialIcons name="chevron-right" size={moderateScale(24)} color={Colors.primary} style={styles.chevron} />
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.recordCard}>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.metaRow}>
                    <MaterialIcons name="domain" size={moderateScale(16)} color={Colors.onSurfaceVariant} />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.hospitalIcon}>
              <MaterialIcons name="health-and-safety" size={moderateScale(24)} color={Colors.primary} />
            </View>
            <View>
          ...
          <View style={styles.cardsContainer}>
            ...
            <TouchableOpacity style={styles.recordCard}>
              <View style={styles.cardHeader}>
                <View style={styles.cardIcon}>
                  <MaterialIcons name="monitor-heart" size={moderateScale(24)} color={Colors.primary} />
                </View>
                <View style={styles.cardContent}>
